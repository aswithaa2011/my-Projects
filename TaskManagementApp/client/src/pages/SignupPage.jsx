...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Account created! Welcome to Taski 🎉");
      navigate("/dashboard");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-brand-bg relative overflow-hidden">
      ...
      <div className="absolute -top-32 -left-32 w-96 h-96 bg-brand-pink/10 rounded-full blur-3xl" />
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-brand-sidebar/20 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm">Start managing your dev journey</p>
        </div>
